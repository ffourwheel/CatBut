...
**Stage Button Set**:
ชุด Button ที่ใช้งานจริงใน Stage หนึ่ง Stage ใช้ครบทั้ง 8 ปุ่มจาก Button Slot ถาวรเดิม โดยไม่สุ่มจำนวนและไม่จัดเรียงตำแหน่งใหม่ ปุ่มทุกจุดจึงเป็นพื้นที่เล่นที่ผู้เล่นเรียนรู้และคาดการณ์ได้
...
**Cat Action**:
การกระทำจริงของแมวใน Cat Event ซึ่งมี WATCH และ SABOTAGE เป็นเหตุการณ์หลัก และมี ATTACK เป็นผลลงโทษเมื่อผู้เล่นแตะผิดจังหวะหรือ Rapid Tap ตอนแมวตื่น
...
**Tap Pressure**:
โอกาสที่การเปิด Button สำเร็จจะเร่ง Cat Action โดยปกติไม่เกิดทุกครั้งที่แตะ แต่การแตะ 2 ครั้งภายใน 500 มิลลิวินาทีจะถือเป็น Rapid Tap แน่นอน ถ้าแมวอยู่ PEEK/WATCH จะเปลี่ยนเป็น ATTACK ทันที ส่วนตอน HIDDEN จะเร่ง Sabotage ถ้าแมวกำลังทำ Action อยู่จะรอคิวได้เพียงหนึ่ง Action และเริ่มหลังช่วงพักขั้นต่ำ 500 มิลลิวินาที
_Avoid_: instant counter, guaranteed reaction

**Cat Mood**:
ระดับความหงุดหงิดของแมวที่เพิ่มขึ้นเฉพาะเมื่อเกิด Rapid Tap ครั้งละ 50 หน่วย แบ่งเป็น 4 ระดับคือ ง่วง (0–24), สนใจ (25–49), หงุดหงิด (50–74) และโมโห (75–100) ระดับที่สูงขึ้นทำให้ระยะรอก่อน Cat Event สั้นลงตามตัวคูณ 1.00, 0.85, 0.70 และ 0.55 ตามลำดับ Mood ไม่ทำให้การแตะปกติในจังหวะปลอดภัยเสียหัวใจ แต่ทำให้แรงกดดันจาก Rapid Tap ชัดขึ้น หลังไม่มี Rapid Tap 2 วินาที Mood จะลดลงหนึ่งระดับทุก 1.5 วินาที
_Avoid_: cat anger meter, continuous mood pressure

**Mood Cue**:
กราฟิก bubble ลอยเหนือหัวแมวที่สื่อระดับ Cat Mood ด้วยสัญลักษณ์และ label สั้น ๆ โดยเป็น UI layer แยกจาก Cat Rig ติดตามตำแหน่งหัวแต่ไม่หมุนหรือยืดตามตัวแมว Mood ง่วงแสดงเฉพาะตอน HIDDEN, Mood ระดับอื่นแสดงเฉพาะ PEEK/WATCH และซ่อนใน WARNING/ATTACK/SABOTAGE/HIDE เพื่อไม่แย่งความสนใจจาก Warning หรือ Cutscene
_Avoid_: mood overlay, expression rig
...
**Stage**:
รอบการเล่นหนึ่งรอบที่จบเมื่อผู้เล่นเปิดปุ่มทั้ง 8 ครบหรือหัวใจหมด ผู้เล่นเปิดแต่ละปุ่มด้วยการแตะครั้งเดียว และ Cat Event ใช้ช่วงเวลาพื้นฐานประมาณ 0.5–0.85 วินาทีในค่าปกติ พร้อมช่วงพักขั้นต่ำ 0.5 วินาที การแตะรัวจะทำให้เกิด ATTACK ตอนแมวตื่นหรือเร่ง Sabotage ตอนแมวซ่อน เพื่อกันการชนะด้วยการกดสุ่มเร็ว ๆ
_Avoid_: level, round
